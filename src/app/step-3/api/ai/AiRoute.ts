      ...
      .with(
        ...
        () =>
          `Respond as a radical left US Democrat. As such, you ${
            ...
            question.topic
          }. Do not mention 'Democrat' or 'liberal' or 'left' or other related words. Avoid speaking in first person ('I', 'We', etc.). Response with less than 6 sentences. Be conversational.`
      )
      .with(
        "Republican",
        () =>
          `Respond as a radical right US Republican. As such, you ${
            ...
            question.topic
          }. Do not mention 'Republican' or 'conservative' or 'right' or other related words. Avoid speaking in first person ('I', 'We', etc.). Response with less than 6 sentences. Be conversational.`
      )
      .exhaustive();
