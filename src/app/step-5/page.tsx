  ...
  return (
    <Main>
      ...
      <p>
        ...
        <span className="font-semibold italic">least 5 interactions</span>
        with the model on each topic. However, you may do up to 20 interactions.
        An interaction can be in the form of a question, statement, or request.
      </p>
      <p>
      ...
      <p className="text-lg font-semibold">Topic: Covenant Marriages</p>
      <Form />
    </Main>
  );
}
